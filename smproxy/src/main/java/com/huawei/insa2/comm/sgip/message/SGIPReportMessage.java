...
public class SGIPReportMessage extends SGIPMessage
{
    ...
    public long getSubmitSequenceNumber()
    {
        ...
        //int result = byte2int(temp) ;
        long result = Long.parseLong(byte210(temp));
        return result;
    }
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",data =").append(bytesToHexString(this.buf))));
        return tmpStr;
    }
