...
public class CMPPConnectMessage extends CMPPMessage
{
        ...
        throws IllegalArgumentException
    {
        ...
        SimpleDateFormat dateFm = new SimpleDateFormat("MMddHHmmss");
        String tmptime = dateFm.format(new java.util.Date());
        ...
        TypeConvert.int2byte(Integer.valueOf(tmptime).intValue(), super.buf, 35);
